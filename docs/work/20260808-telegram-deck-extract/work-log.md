...
- 다음 작업 (TASK-12 계속):
  1. **cmd_0018 결과 확인**: output\agent_shell\done_0018.txt·res_0018.log (2회 scan 요약·종료 코드), DB 카운트 — 1차는 aborted(내비 실패, 원인 로그 확인), 2차가 본 순회였음. AC-03 판정은 재실행 카운트 비교로 다시 수행.
